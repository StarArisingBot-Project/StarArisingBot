...
___
<div>
	<img align="left" width="150px" src="./.github/Images/Icons/Projects/SAB MinigameEngine (Icon).png"/>
...
<!-- Compilação -->
## 🛠️ • Compilar e Executar StarArisingBot
<p>Caso você tenha interesse em compilar o bot, abaixo há algumas instruções e recomendações a você!</p>

### ```0.``` Pré-Requisitos
- Você precisa ter o Visual Studio 2019 (a versão mínima é 16.11.9) instalado em sua máquina.
- Você precisa ter o Git instalado em sua máquina.
- Você precisará de SDKs para .NET 4.5, 4.6 e 4.7.

<br/>

### ```1.``` Preparando Ambiente 
<p>• Clone o repositório usando o Git:</p>
...
- Com o VisualStudio (ou qualquer outra IDE de preferência) aberto selecione a Solução do projeto;
- Compile o projeto utilizando o comando abaixo no terminal:

```
dotnet build
```
- Se tudo estiver correto, o projeto irá ser compilado sem problema algum.

<br/>

### ```3.``` Executando o Projeto
- Após a compilação, vá para a pasta onde o projeto foi compilado;
- Na pasta crie um arquivo chamado ".env" (Sem as aspas);
- Neste arquivo coloque as informações do arquivo template localizado <a href="./.github/Templates/System/.env (TEMPLATE)">Aqui</a>;
- Substitua e preencha todas as informações requeridas.
- Execute o Bot.

<br/>

<p><b>🎉 • Se tudo ocorrer corretamente, o Bot será iniciado e executado com sucesso!</b></p>
